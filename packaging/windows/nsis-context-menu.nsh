...
!macro ZM_REGISTER_ORDERED_SUBCOMMANDS
  ...
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "01OpenArchive" "Open archive" "open" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "02ExtractHere" "Extract Here" "extract-here" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "03AddToArchive" "Add to archive..." "compress" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "04AddToTzap" "Add to .tzap" "compress-tzap" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "05AddToZip" "Add to .zip" "compress-zip" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "06AddToSevenZ" "Add to .7z" "compress-7z" "%1"
  !insertmacro ZM_WRITE_SUBCOMMAND_VERB "${ZM_ARCHIVE_SUBCOMMANDS_KEY}" "07AddToTzst" "Add to .tzst" "compress-tzst" "%1"
