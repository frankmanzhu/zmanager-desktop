...
!define ZM_NON_ARCHIVE_FILE_APPLIES_TO "NOT System.FileExtension:=.7z AND NOT System.FileExtension:=.7z.001 AND NOT System.FileExtension:=.a AND NOT System.FileExtension:=.aar AND NOT System.FileExtension:=.aea AND NOT System.FileExtension:=.apk AND NOT System.FileExtension:=.appx AND NOT System.FileExtension:=.ar AND NOT System.FileExtension:=.b64 AND NOT System.FileExtension:=.br AND NOT System.FileExtension:=.bz2 AND NOT System.FileExtension:=.cab AND NOT System.FileExtension:=.cb7 AND NOT System.FileExtension:=.cbr AND NOT System.FileExtension:=.cbt AND NOT System.FileExtension:=.cbz AND NOT System.FileExtension:=.cpgz AND NOT System.FileExtension:=.cpio AND NOT System.FileExtension:=.cpio.bz2 AND NOT System.FileExtension:=.cpio.gz AND NOT System.FileExtension:=.cpio.lzma AND NOT System.FileExtension:=.cpio.xz AND NOT System.FileExtension:=.cpio.zst AND NOT System.FileExtension:=.deb AND NOT System.FileExtension:=.epub AND NOT System.FileExtension:=.gz AND NOT System.FileExtension:=.ipa AND NOT System.FileExtension:=.iso AND NOT System.FileExtension:=.jar AND NOT System.FileExtension:=.lha AND NOT System.FileExtension:=.lz AND NOT System.FileExtension:=.lz4 AND NOT System.FileExtension:=.lzh AND NOT System.FileExtension:=.lzma AND NOT System.FileExtension:=.lzo AND NOT System.FileExtension:=.msi AND NOT System.FileExtension:=.mtree AND NOT System.FileExtension:=.pax AND NOT System.FileExtension:=.rar AND NOT System.FileExtension:=.rpm AND NOT System.FileExtension:=.sevenz AND NOT System.FileExtension:=.tar AND NOT System.FileExtension:=.tar.b64 AND NOT System.FileExtension:=.tar.br AND NOT System.FileExtension:=.tar.bz2 AND NOT System.FileExtension:=.tar.gz AND NOT System.FileExtension:=.tar.lrz AND NOT System.FileExtension:=.tar.lz AND NOT System.FileExtension:=.tar.lz4 AND NOT System.FileExtension:=.tar.lzma AND NOT System.FileExtension:=.tar.lzo AND NOT System.FileExtension:=.tar.uu AND NOT System.FileExtension:=.tar.xz AND NOT System.FileExtension:=.tar.z AND NOT System.FileExtension:=.tar.zst AND NOT System.FileExtension:=.taz AND NOT System.FileExtension:=.tbz AND NOT System.FileExtension:=.tbz2 AND NOT System.FileExtension:=.tgz AND NOT System.FileExtension:=.tlzma AND NOT System.FileExtension:=.txz AND NOT System.FileExtension:=.tzap AND NOT System.FileExtension:=.tzst AND NOT System.FileExtension:=.udf AND NOT System.FileExtension:=.ustar AND NOT System.FileExtension:=.uu AND NOT System.FileExtension:=.vhd AND NOT System.FileExtension:=.vmdk AND NOT System.FileExtension:=.vol000.tzap AND NOT System.FileExtension:=.war AND NOT System.FileExtension:=.xar AND NOT System.FileExtension:=.xpi AND NOT System.FileExtension:=.xz AND NOT System.FileExtension:=.z AND NOT System.FileExtension:=.zip AND NOT System.FileExtension:=.zipx AND NOT System.FileExtension:=.zst"
