        ...
        <details id="create-advanced-options" className="group mt-3 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
          ...
          <div className="grid gap-4 border-t border-black/10 px-4 py-4 dark:border-white/10">
            ...
            {capabilities.sevenZAdvanced ? (
              ...
              <HelpTooltip content={i18n.t("create.sevenZSolid.tooltip")}><label className="flex items-center gap-2"><input id="create-7z-solid" type="checkbox" checked={options.sevenZSolid} onChange={(event) => actions.handleCreateIntent({ type: "setOptions", patch: { sevenZSolid: event.currentTarget.checked } })} /><span>{i18n.t("create.sevenZSolid")}</span></label></HelpTooltip>
              <HelpTooltip content={i18n.t("create.sevenZEncryptFileNames.tooltip")}><label className="flex items-center gap-2"><input id="create-7z-encrypt-names" type="checkbox" checked={options.sevenZEncryptFileNames} onChange={(event) => actions.handleCreateIntent({ type: "setOptions", patch: { sevenZEncryptFileNames: event.currentTarget.checked } })} /><span>{i18n.t("create.sevenZEncryptFileNames")}</span></label></HelpTooltip>
              </section>
            ) : null}
            {options.format === "tzap" ? (
