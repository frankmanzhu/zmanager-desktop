...
function AppShellSurface({
  ...
  return (
    <div
      className="h-screen min-h-screen min-w-[320px] overflow-hidden bg-slate-100 text-slate-950 dark:bg-slate-950 dark:text-slate-50 [&_input:not([type=checkbox]):not([type=radio])]:h-8 [&_input:not([type=checkbox]):not([type=radio])]:min-w-0 [&_input:not([type=checkbox]):not([type=radio])]:rounded-md [&_input:not([type=checkbox]):not([type=radio])]:border [&_input:not([type=checkbox]):not([type=radio])]:border-slate-300 [&_input:not([type=checkbox]):not([type=radio])]:bg-white [&_input:not([type=checkbox]):not([type=radio])]:px-2 [&_input:not([type=checkbox]):not([type=radio])]:text-sm [&_input:not([type=checkbox]):not([type=radio])]:outline-none [&_input:not([type=checkbox]):not([type=radio])]:focus:border-blue-500 [&_input:not([type=checkbox]):not([type=radio])]:focus:ring-2 [&_input:not([type=checkbox]):not([type=radio])]:focus:ring-blue-500/20 dark:[&_input:not([type=checkbox]):not([type=radio])]:border-slate-700 dark:[&_input:not([type=checkbox]):not([type=radio])]:bg-slate-950 [&_input[type=checkbox]]:size-4 [&_input[type=checkbox]]:accent-blue-600 [&_input[type=radio]]:size-4 [&_input[type=radio]]:accent-blue-600 [&_select]:h-8 [&_select]:min-w-0 [&_select]:rounded-md [&_select]:border [&_select]:border-slate-300 [&_select]:bg-white [&_select]:px-2 [&_select]:text-sm [&_select]:outline-none [&_select]:focus:border-blue-500 [&_select]:focus:ring-2 [&_select]:focus:ring-blue-500/20 dark:[&_select]:border-slate-700 dark:[&_select]:bg-slate-950 [&_textarea]:rounded-md [&_textarea]:border [&_textarea]:border-slate-300 [&_textarea]:bg-white [&_textarea]:p-2 dark:[&_textarea]:border-slate-700 dark:[&_textarea]:bg-slate-950 [&_progress]:h-2 [&_progress]:w-full"
