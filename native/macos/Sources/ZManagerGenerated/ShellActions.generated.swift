...
public struct ShellActionPolicy: Equatable, Sendable {
    ...
    public static let all: [ShellActionPolicy] = [
        ...
        .init(id: .compressShareOnLan, canonicalLabel: "Compress and Share on LAN", displayKey: "shellAction.compressShareOnLan", nativeVerb: "CompressShareOnLan", order: 82, contextMenuOrder: 100, contextMenuContexts: ["archiveSingle", "archiveMultiple", "creation", "container"], selectionShapes: ["single-archive", "multiple-archives", "files", "folders", "mixed"], multiplicity: "one-or-more", nativeSurfaces: ["windowsExplorer", "linuxDesktop", "linuxNautilus", "linuxKde", "macosFinder", "macosServices"]),
        .init(id: .shareOnLan, canonicalLabel: "Share on LAN", displayKey: "shellAction.shareOnLan", nativeVerb: "ShareOnLan", order: 83, contextMenuOrder: 105, contextMenuContexts: ["archiveSingle", "creation", "container"], selectionShapes: ["files"], multiplicity: "exactly-one", nativeSurfaces: ["windowsExplorer", "linuxDesktop", "linuxNautilus", "linuxKde", "macosFinder", "macosServices"]),
